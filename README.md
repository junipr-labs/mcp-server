...
MCP server for [Junipr](https://junipr.io) APIs. Gives AI assistants the ability to capture screenshots, generate PDFs, and extract metadata from any webpage.
...
Sign up at [junipr.io/pricing](https://junipr.io/pricing) to get a free or paid API key.
